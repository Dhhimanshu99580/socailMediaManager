...
- [Twitter OAuth 2.0 Flow](#twitter-oauth-20-flow)
...
1. Branch off `main` — use `dev/<feature-name>` naming
2. Keep changes scoped; one feature/fix per PR
3. Ensure `./mvnw test` passes before opening a PR
4. Update this README if you add new endpoints, config properties, or change the DB schema
